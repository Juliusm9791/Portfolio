...
function openPDF() {
  ...
  myWindow.document.write('<title>Julius resume</title><iframe src="./assets/pdf/Julius_Markauskas_resume1.pdf" width="100%" height="100%"></iframe>');
}